...
<!-- 
                      <div class="form-group">
                       ...
                       <!-- <button ></button> -->
                       <input type="submit" class="btn btn-info" value="Edit Trainee"> 
                      </form>
                    </ValidationObserver>
                  </div>
...
export default {
    ...
    created(){
        ...
        this.addTrineeForm = JSON.parse(localStorage.getItem('UserToEdit'));
        this.selectedPhoto = this.addTrineeForm.photo;
        this.urlForSelectedPhoto = this.addTrineeForm.photo;
