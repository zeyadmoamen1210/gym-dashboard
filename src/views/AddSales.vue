                ...
                <form @submit.prevent="handleSubmit(sendSalesToBackend)">
                  <div class="receptionist-form">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  <ValidationProvider rules="required" v-slot="password">
                                    <vs-input state="dark" type="password" v-model="addSalesForm.password" placeholder="Password">
                                        <template #icon>
                    ...
                    <div class="form-group">
                        ...
                        <vs-input state="dark" type="number" v-model="addSalesForm.age" placeholder="Age">
                            <template #icon>
...
<!-- 
                    ...
                    <input type="submit" class="btn btn-info" value="Add Sales">
                    </form>
                  </ValidationObserver>
              </div>
...
export default {
    ...
    methods:{
        ...
        sendSalesToBackend(){
            ...
            formDate.append("password", this.addSalesForm.password);
