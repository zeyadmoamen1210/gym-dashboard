      ...
      <div class="container">
          <div class="row">
              <div class="col-md-8">
                ...
                <form @submit.prevent="handleSubmit(sendReceptionestToBackend)">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <ValidationProvider rules="required" v-slot="username">
                                    <vs-input state="dark"  v-model="addReceptionestForm.username" placeholder="User Name">
                                        <template #icon>
                          ...
                          <!-- <div class="col-md-6">
                              ...
                              <div class="form-group">
                                  <ValidationProvider rules="required|email" v-slot="email">
                                    <vs-input state="dark"  v-model="addReceptionestForm.email" placeholder="Email Address">
                                        <template #icon>
                              ...
                              <div class="form-group">
                                  <ValidationProvider rules="required" v-slot="phone">
                                    <vs-input state="dark"  v-model="addReceptionestForm.phone" placeholder="Phone Number">
                                        <template #icon>
                    ...
                    <!-- <div class="form-group">
                      ...
                      <div class="form-group">
                            ...
                            <ValidationProvider rules="required" v-slot="status">
                                <v-select
                                class="select-time"
                                v-model="addReceptionestForm.status"
                                label="text"
                      ...
                      <div class="form-group">
                          ...
                          <vs-input state="dark" type="text" v-model="addReceptionestForm.address" placeholder="Address">
                            <template #icon>
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div>
                                   <vs-radio style="    margin-bottom: 15px;" v-model="addReceptionestForm.gender" val="male">
                                        Male
                                    </vs-radio>
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div>
                                   <vs-radio style="    margin-bottom: 15px;" v-model="addReceptionestForm.gender" val="female">
                                        Female
                                    </vs-radio>
                              </div>
                          </div>
...
<!-- 
                    ...
                    <input type="submit" class="btn btn-info" value="Edit Receptionest">
                    </form>
                  </ValidationObserver>
              </div>
...
export default {
    ...
    created(){
        ...
        this.addReceptionestForm = JSON.parse(localStorage.getItem('UserToEdit'));
        this.selectedPhoto = this.addReceptionestForm.photo;
        this.urlForSelectedPhoto = this.addReceptionestForm.photo;
    ...
    methods:{
        ...
        sendReceptionestToBackend(){
            ...
            formDate.append("username", this.addReceptionestForm.username);
            // formDate.append("password", this.addReceptionestForm.password);
            formDate.append("email", this.addReceptionestForm.email);
            formDate.append("phone", this.addReceptionestForm.phone);
            formDate.append("gender", this.addReceptionestForm.gender);
            // formDate.append("age", this.addReceptionestForm.age);
            formDate.append("role", 'reciptionest');
            formDate.append("userId", this.$route.params.id);
            if(this.selectedPhoto){
                formDate.append("photo", this.selectedPhoto);
            }
            formDate.append("address", this.addReceptionestForm.address);
            formDate.append("status", this.addReceptionestForm.status);
            ...
            axiosApi.put('/updateProfileAdmin', formDate , {
                ...
                this.$vs.notification({
                    title:"Success !",
                    text:`Reciptionest Added Successfully`,
                    color:"success",
                    position:"top-center"
                });
